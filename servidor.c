...
void envia_sinal_entrar_jogo(userr n){//recebe o vetor dinamico-->funcao que tem como objectivo mostrar o jogo aos clientes
int i;
union sigval sig;
...
void envia_sinal_sair_jogo_aos_clis(userr nn){//funcao que diz aos clientes que o servidor vai terminar
